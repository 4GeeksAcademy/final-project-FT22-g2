...
const Direccion = () => {
    ...
    const handleDireccionValidacion  = (e) => {
        e.preventDefault();

        const { comuna, calle, numero, contacto, codigopostal, region } = state;

        if (!comuna || !calle || !numero || !contacto || !codigopostal || !region) {
                ...
                <div className="card-body" style={{ borderRadius: "10px", boxShadow: "0 0 10px #dadada" }}>
                    <form className="needs-validation" noValidate>
                        ...
                        <div className="boton-actualizar-cambiarDireccion p-3">
                            <button type="submit" className="btn btn-secondary btn-sm boton-actualizar-cambiarDireccion" onClick={handleDireccionValidacion}>
                                Validar dirección
                            </button>
                        </div>
                    </form>
