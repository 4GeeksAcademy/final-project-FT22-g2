...
const Single = () => {
  ...
  return (
    <div className="container-fluid my-5">
      <div className="row margin-container-productCard m-0 p-0 d-flex justify-content-center">
        ...
        <div className="col-3">
          <div className="">
            ...
            <div className="productCard-add-remove-btn d-inline-flex align-items-center justify-content-between">
